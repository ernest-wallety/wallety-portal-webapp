export class ConfigHelper {
  ...
  public static NG_APP_USER_STORAGE_NAME: string = import.meta.env[
    "NG_APP_USER_STORAGE_NAME"
  ];
  public static NG_APP_MENU_STORAGE_NAME: string = import.meta.env[
    "NG_APP_MENU_STORAGE_NAME"
  ];
