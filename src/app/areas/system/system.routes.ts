...
export const routes: Routes = [
   {
      path: '', component: SystemComponent, children: [
         ...
         {
            path: 'merchants',
            loadComponent: () => import(`./merchants/merchants.component`)
               .then(mod => mod.MerchantsComponent),
            data: { animation: 'MerchantsPage' },
            canActivate: [AuthGuard]
         },
         {
            path: 'customer-verification',
            loadComponent: () => import(`./customer-verification/customer-verification-list.component`)
